...
export const erpTabs: PortalTab[] = [
  ...
  { value: "authorizations", label: "Rental Authorizations", icon: <ShieldCheck className="h-4 w-4" /> },
  ...
  { value: "iot-provisioning", label: "Auto Provisioning", icon: <Cpu className="h-4 w-4" /> },
