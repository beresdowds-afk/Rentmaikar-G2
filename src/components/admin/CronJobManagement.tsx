...
const CRON_JOBS: CronJob[] = [
  ...
  },
  {
    ...
    description: "Dispatches queued transactional and auth emails with automated retries, rate limiting, and DLQ handling.",
    icon: <Mail className="h-4 w-4" />,
    category: "notifications",
  },
  {
    id: "dispatch-event-notifications",
    name: "Event Notification Dispatcher",
    functionName: "dispatch-event-notifications",
    schedule: "*/2 * * * *",
    humanSchedule: "Every 2 minutes",
    description: "Processes event notification outbox across push, email, SMS, and webhooks.",
    icon: <Send className="h-4 w-4" />,
    category: "notifications",
  },
  {
    id: "send-booking-reminders",
    name: "Booking 24h Reminders",
    functionName: "send-booking-reminders",
    schedule: "0 8 * * *",
    humanSchedule: "Every day at 8:00 AM UTC",
    description: "Emails reminder notifications to drivers whose accepted rental booking starts within 24 hours.",
    icon: <Clock className="h-4 w-4" />,
    category: "notifications",
  },
  {
    id: "persona-reconcile",
    name: "Persona KYC Reconciler",
    functionName: "persona-reconcile",
    schedule: "*/15 * * * *",
    humanSchedule: "Every 15 minutes",
    description: "Reconciles KYC verification statuses and recovers from missed Persona webhook events.",
    icon: <ShieldCheck className="h-4 w-4" />,
    category: "admin",
  },
  {
    id: "email-domain-status-check",
    name: "Email Domain Health Check",
    functionName: "email-domain-status-check",
    schedule: "*/30 * * * *",
    humanSchedule: "Every 30 minutes",
    description: "Audits DNS delegation for notify.rentmaikar.com and verifies auth email deliverability.",
    icon: <Globe className="h-4 w-4" />,
    category: "admin",
  },
  {
    id: "sarekon-location-worker",
    name: "GPS Telemetry Worker",
    functionName: "sarekon-location-worker",
    schedule: "* * * * *",
    humanSchedule: "Every minute",
    description: "Polls GPS and track locations, maps telemetry into the unified model, and updates vehicle coordinates.",
    icon: <Radio className="h-4 w-4" />,
    category: "fleet",
  },
  {
    id: "gps-worker-watchdog",
    name: "GPS Worker Watchdog",
    functionName: "gps-worker-watchdog",
    schedule: "*/5 * * * *",
    humanSchedule: "Every 5 minutes",
    description: "Monitors GPS ingestion feeds for stalls and alerts administrators if telemetry updates lag.",
