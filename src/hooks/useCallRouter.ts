...
const DEFAULT_RECEIVERS: Omit<AdminReceiver, 'isCurrentUser'>[] = [
  ...
  {
    id: 'rec-beresdowds',
    userId: 'admin-beresdowds-1',
    name: 'Beres & Dowds (Admin)',
    email: 'beresdowds@gmail.com',
    role: 'admin',
    phone: '',
    status: 'available',
    availableSince: new Date(Date.now() - 15 * 60 * 1000).toISOString(),
    lastCallEndedAt: new Date(Date.now() - 20 * 60 * 1000).toISOString(),
    totalCallsHandled: 5,
    regionSpecialty: 'All',
    notes: 'Platform Administrator & Fleet Control',
  },
  {
    id: 'rec-eastforte',
    userId: 'admin-eastforte-1',
    name: 'Olusola Adebayo (Admin)',
    email: 'eastfortemain@gmail.com',
    role: 'admin',
    phone: '+2348139051772',
    status: 'available',
    availableSince: new Date(Date.now() - 20 * 60 * 1000).toISOString(),
    lastCallEndedAt: new Date(Date.now() - 30 * 60 * 1000).toISOString(),
    totalCallsHandled: 5,
    regionSpecialty: 'All',
    notes: 'Platform Administrator & Operations Lead',
  },
  {
    id: 'rec-sarah',
