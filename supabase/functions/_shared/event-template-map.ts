...
export interface EventTemplateMapping {
  ...
  sms: string;
  /** Meta-approved WhatsApp HSM template name (whatsapp-templates.ts). */
...
export const EVENT_TEMPLATE_MAP: EventTemplateMapping[] = [
  // ---------------------------------------------------------------- Applications
  {
    ...
    whatsappTemplateName: "driver_welcome",
  ...
  },
  {
    ...
    whatsappTemplateName: "document_verified",
  ...
  // ------------------------------------------------------------------- Invoices
  {
    ...
    whatsappTemplateName: "payment_reminder_72h",
  ...
  },
  {
    ...
    whatsappTemplateName: "payment_overdue_24h_final",
  ...
  },
  {
    ...
    whatsappTemplateName: "payment_overdue_8h",
    whatsapp: `Hi {{first_name}},\n\nYour recent payment attempt failed. Please update your payment method and retry from your dashboard to avoid a late fee.\n\n${SUPPORT_SIGNOFF}`,
  ...
  },
  {
    ...
    whatsappTemplateName: "rental_status",
  ...
  // -------------------------------------------------------------------- Rentals
  {
    ...
    audience: "all",
    channels: ["email", "push", "sms", "whatsapp"],
    emailTemplate: "vehicle_assigned",
    ...
    whatsappTemplateName: "vehicle_assigned",
  ...
  // ------------------------------------------------------------------- Bookings
  {
    ...
    whatsappTemplateName: "owner_vehicle_booked",
  ...
  // -------------------------------------------------------------- Negotiations
  {
    ...
    audience: "all",
    channels: ["email", "push", "sms"],
    emailTemplate: "negotiation_submitted",
  ...
  },
  {
    ...
    audience: "all",
    channels: ["email", "push", "sms", "whatsapp"],
    emailTemplate: "negotiation_approved",
    ...
    whatsappTemplateName: "negotiation_approved",
  ...
  },
  {
    ...
    audience: "all",
    channels: ["email", "push", "sms"],
    emailTemplate: "negotiation_rejected",
  ...
  },
  {
    ...
    audience: "all",
    channels: ["email", "push", "sms"],
    emailTemplate: "negotiation_locked",
  ...
  },
  {
    ...
    audience: "all",
    channels: ["email", "push"],
    emailTemplate: "negotiation_counter_offer",
  ...
  // ------------------------------------------------------------------- Payouts
  {
    ...
    whatsappTemplateName: "owner_payout",
