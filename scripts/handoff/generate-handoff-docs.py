...
CRED = {
 ...
 "RESEND_WEBHOOK_SIGNING_SECRET": ("Resend", "Svix signing secret (whsec_...) to verify delivery/bounce/spam webhooks", "Resend dashboard > Webhooks > Signing Secret", "High", "Semi-annual"),
 "RESEND_WEBHOOK_SECRET": ("Resend", "Legacy alias for RESEND_WEBHOOK_SIGNING_SECRET", "Resend dashboard > Webhooks", "High", "Semi-annual"),
